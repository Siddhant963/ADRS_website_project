...
<?php include './Nav.php'; ?>
    ...
    <div class="single-service"> -->
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="single-service">
                    <div class="pull-left1 hove">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="iconn">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="single-service">
                    ...
                    <div class="media-content">
                        <!-- <h3><a href="#">Quality</a></h3> -->
                        <p style="color: #629584;">We believe that we can make a difference to your bussiness and we do.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="single-service">
                    ...
                    <div class="media-content" >
                        <!-- <h3><a href="#">Quality</a></h3> -->
                        <p style="color: #629584;">Content is king. You’ll hear that phrase over and over again when it comes ADRS Techno Private
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="single-service">
                    ...
                    <div class="media-content">
                        <!-- <h3><a href="#">Quality</a></h3> -->
                        <p style="color: #629584;">We provide 24 hr technical support.</p>
                    </div>
                </div>
            </div>
