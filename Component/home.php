        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a style="color: #ffff;" class="nav-link" href="#">Training</a>
                    </li>
                    <li class="nav-item">
                        <a style="color: #ffff;" class="nav-link" href="#">Registration</a>
                    </li>
                    <li class="nav-item">
                        <a style="color: #ffff;" class="nav-link" href="#">Blog</a>
                    </li>
                    <li class="nav-item">
                        <a style="color: #ffff;" class="nav-link" href="#">Gallery</a>
                    </li>
                    <li class="nav-item">
                        <a style="color: #ffff;" class="nav-link" href="#">Contact</a>
                    </li>
                    <li class="nav-item">
                        <a style="color: #ffff;" class="nav-link" href="#">Verify</a>
                    </li>
                </ul>
            </div>
        </div>
